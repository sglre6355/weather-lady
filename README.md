...
- Captures weather forecast images from tenki.jp
...
1. Generate protobuf code:
   ```bash
   protoc --go_out=. --go-grpc_out=. proto/vendor/web_capture/v1/web_capture.proto
   ```
...
3. Run `/unsubscribe-weather` to stop all weather updates for the channel

## Technical Details

- Uses discordgo library for Discord interactions
- Captures weather forecast images from https://tenki.jp/#forecast-public-date-entry-2
- Targets the `#forecast-map-wrap` element for image capture
